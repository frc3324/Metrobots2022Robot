...
public final class PracticeConsts {
    ...
    public static class Climber {
        ...
        public static final DigitalInput RIGHT_LONG_HOOK_SWITCH = new DigitalInput(1);
        public static final DigitalInput LEFT_LONG_HOOK_SWITCH = new DigitalInput(8);
